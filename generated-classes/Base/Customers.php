...
abstract class Customers implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\CustomersTableMap';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CustomersTableMap::COL_ID] = true;
        }
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[CustomersTableMap::COL_FIRST_NAME] = true;
        }
    ...
    public function setLastName($v)
    {
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[CustomersTableMap::COL_LAST_NAME] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CustomersTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = CustomersTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(CustomersTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CustomersTableMap::COL_FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'first_name';
        }
        if ($this->isColumnModified(CustomersTableMap::COL_LAST_NAME)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(CustomersTableMap::COL_ID)) {
            $criteria->add(CustomersTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CustomersTableMap::COL_FIRST_NAME)) {
            $criteria->add(CustomersTableMap::COL_FIRST_NAME, $this->first_name);
        }
        if ($this->isColumnModified(CustomersTableMap::COL_LAST_NAME)) {
            $criteria->add(CustomersTableMap::COL_LAST_NAME, $this->last_name);
        }
        if ($this->isColumnModified(CustomersTableMap::COL_EMAIL)) {

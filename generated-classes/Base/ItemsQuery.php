 ...
 * @method     ChildItemsQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildItemsQuery groupById() Group by the id column
 * @method     ChildItemsQuery groupByName() Group by the name column
 *
 ...
 *
 * @method     ChildItems|null findOne(?ConnectionInterface $con = null) Return the first ChildItems matching the query
 ...
 *
 * @method     ChildItems|null findOneById(int $id) Return the first ChildItems filtered by the id column
 * @method     ChildItems|null findOneByName(string $name) Return the first ChildItems filtered by the name column
 *
 ...
 * @method     ChildItems requireOneByName(string $name) Return the first ChildItems filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildItems[]|Collection find(?ConnectionInterface $con = null) Return ChildItems objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildItems> find(?ConnectionInterface $con = null) Return ChildItems objects based on current ModelCriteria
 *
 * @method     ChildItems[]|Collection findById(int|array<int> $id) Return ChildItems objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildItems> findById(int|array<int> $id) Return ChildItems objects filtered by the id column
 * @method     ChildItems[]|Collection findByName(string|array<string> $name) Return ChildItems objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildItems> findByName(string|array<string> $name) Return ChildItems objects filtered by the name column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildItems> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class ItemsQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'orders', $modelName = '\\Items', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name FROM items WHERE id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(ItemsTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(ItemsTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ItemsTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ItemsTableMap::COL_NAME, $name, $comparison);

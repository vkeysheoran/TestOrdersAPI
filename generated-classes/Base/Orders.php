...
abstract class Orders implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\OrdersTableMap';
    ...
    /**
     * The value for the expected_delivery field.
     *
     * @var        DateTime
     */
    protected $expected_delivery;
    ...
    /**
     * The value for the order_items field.
     *
     * @var        int
     */
    ...
    /**
     * Get the [optionally formatted] temporal [expected_delivery] column value.
     *
     *
     ...
     */
    public function getExpectedDelivery($format = null)
    {
        if ($format === null) {
            return $this->expected_delivery;
        } else {
            return $this->expected_delivery instanceof \DateTimeInterface ? $this->expected_delivery->format($format) : null;
        }
    }
    ...
    /**
     * Get the [order_items] column value.
     *
     * @return int
     */
    ...
    public function setDeliveryAddress($v)
    {
        ...
        if ($this->delivery_address !== $v) {
            ...
            $this->modifiedColumns[OrdersTableMap::COL_DELIVERY_ADDRESS] = true;
        }
    ...
    public function setBillingAddress($v)
    {
        ...
        if ($this->billing_address !== $v) {
            ...
            $this->modifiedColumns[OrdersTableMap::COL_BILLING_ADDRESS] = true;
        }
    ...
    /**
     * Sets the value of [expected_delivery] column to a normalized version of the date/time value specified.
     *
     * @param string|integer|\DateTimeInterface $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this The current object (for fluent API support)
     */
    public function setExpectedDelivery($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->expected_delivery !== null || $dt !== null) {
            if ($this->expected_delivery === null || $dt === null || $dt->format("Y-m-d") !== $this->expected_delivery->format("Y-m-d")) {
                $this->expected_delivery = $dt === null ? null : clone $dt;
                $this->modifiedColumns[OrdersTableMap::COL_EXPECTED_DELIVERY] = true;
            }
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[OrdersTableMap::COL_CUSTOMER_ID] = true;
        }
    ...
    /**
     * Set the value of [order_items] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setOrderItems($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->order_items !== $v) {
            $this->order_items = $v;
            $this->modifiedColumns[OrdersTableMap::COL_ORDER_ITEMS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OrdersTableMap::translateFieldName('DeliveryAddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->delivery_address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OrdersTableMap::translateFieldName('BillingAddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billing_address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OrdersTableMap::translateFieldName('ExpectedDelivery', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->expected_delivery = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OrdersTableMap::translateFieldName('CustomerId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    {
        if ($this->aCustomers !== null && $this->customer_id !== $this->aCustomers->getId()) {
            $this->aCustomers = null;
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(OrdersTableMap::COL_DELIVERY_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'delivery_address';
        }
        if ($this->isColumnModified(OrdersTableMap::COL_BILLING_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'billing_address';
        }
        if ($this->isColumnModified(OrdersTableMap::COL_EXPECTED_DELIVERY)) {
            $modifiedColumns[':p' . $index++]  = 'expected_delivery';
        }
        if ($this->isColumnModified(OrdersTableMap::COL_CUSTOMER_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'expected_delivery':
                        $stmt->bindValue($identifier, $this->expected_delivery ? $this->expected_delivery->format("Y-m-d") : null, PDO::PARAM_STR);
                        break;
                    case 'customer_id':
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 3:
                return $this->getExpectedDelivery();
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDeliveryAddress(),
            $keys[2] => $this->getBillingAddress(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setExpectedDelivery($value);
                break;
            case 4:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setDeliveryAddress($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setBillingAddress($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setExpectedDelivery($arr[$keys[3]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(OrdersTableMap::COL_DELIVERY_ADDRESS)) {
            $criteria->add(OrdersTableMap::COL_DELIVERY_ADDRESS, $this->delivery_address);
        }
        if ($this->isColumnModified(OrdersTableMap::COL_BILLING_ADDRESS)) {
            $criteria->add(OrdersTableMap::COL_BILLING_ADDRESS, $this->billing_address);
        }
        if ($this->isColumnModified(OrdersTableMap::COL_EXPECTED_DELIVERY)) {
            $criteria->add(OrdersTableMap::COL_EXPECTED_DELIVERY, $this->expected_delivery);
        }
        if ($this->isColumnModified(OrdersTableMap::COL_CUSTOMER_ID)) {
            $criteria->add(OrdersTableMap::COL_CUSTOMER_ID, $this->customer_id);
        }
        if ($this->isColumnModified(OrdersTableMap::COL_ORDER_ITEMS)) {
    ...
    {
        if ($this->aCustomers === null && ($this->customer_id != 0)) {
            $this->aCustomers = ChildCustomersQuery::create()->findPk($this->customer_id, $con);

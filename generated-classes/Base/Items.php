...
abstract class Items implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\ItemsTableMap';
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ItemsTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ItemsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ItemsTableMap::COL_NAME)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ItemsTableMap::COL_NAME)) {
            $criteria->add(ItemsTableMap::COL_NAME, $this->name);
        }

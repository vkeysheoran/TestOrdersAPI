...
class ItemsTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.ItemsTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'Items';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Items';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Items';
     ...
     */
    public const COL_ID = 'items.id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'items.name';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [ItemsTableMap::COL_ID, ItemsTableMap::COL_NAME, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [ItemsTableMap::COL_ID => 0, ItemsTableMap::COL_NAME => 1, ],
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'items.id' => 'ID',
        'ItemsTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Name' => 'NAME',
        'Items.Name' => 'NAME',
        'name' => 'NAME',
        'items.name' => 'NAME',
        'ItemsTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
    ];
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ItemsTableMap::COL_NAME);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ItemsTableMap::COL_ID);
            $criteria->removeSelectColumn(ItemsTableMap::COL_NAME);
        } else {
